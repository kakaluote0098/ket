...
第二阶段新增 8 课时语法体系升级，系统覆盖 KET 基础必考语法：

- **现在进行时**：结构、用法、标志词、与一般现在时的区别
- **一般过去时核心用法**：规则/不规则动词、句式变换、否定句与疑问句
- **形容词与副词**：原级用法、比较级构成与基础用法
- **情态动词**：can / must / should 的基本含义与运用
- **并列句**：and / but / or / so 连接简单句
- **简单状语从句入门**：when / because / if 引导的时间、原因、条件状语从句

每个语法点配置专项讲解、例句、常见错误提示及配套练习题，确保学生能够完成陈述句、否定句、疑问句之间的基础句式变换。

#### 2.4.5 题型认知入门（第二阶段）

第二阶段新增 4 课时「题型认知入门」模块，帮助学生零基础适配 KET 考试模式：

| 课时 | 模块 | 内容 |
|------|------|------|
| 第 1 课 | KET 阅读 | 考试规则、评分标准、题型分类（如匹配题、选择题、完形填空）及基础答题逻辑 |
| 第 2 课 | KET 写作 | 考试规则、评分标准、题型分类（如邮件/便条、看图写话）及基础答题逻辑 |
| 第 3 课 | KET 听力 | 考试规则、评分标准、题型分类（如选择题、填空题、匹配题）及基础答题逻辑 |
| 第 4 课 | KET 口语 | 考试规则、评分标准、流程环节（自我介绍、协作讨论）及基础应答逻辑 |

每课时通过图文卡片形式讲解规则与技巧，并提供 1-2 道示例题目，让学生提前熟悉真实考试题型与答题思路。
